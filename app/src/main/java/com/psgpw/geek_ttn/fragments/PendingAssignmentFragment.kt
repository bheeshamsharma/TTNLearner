 ...
 * Use the [PendingAssignmentFragment.newInstance] factory method to
...
class PendingAssignmentFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PendingAssignmentFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PendingAssignmentFragment().apply {
