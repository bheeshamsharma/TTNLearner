...
import com.psgpw.geek_ttn.databinding.FragmentMylearningBinding
...
class MylearningFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentMylearningBinding.inflate(inflater)

        var rootview=inflater.inflate(R.layout.fragment_mylearning, container, false)
        return rootview
    }
